...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Minnie', 				'discord',		'Artist, and cool woman',							'https://www.google.com', 'FFFFFF'],
			['Xamu', 				'discord',		'Made the chart for moment',		'https://www.youtube.com/channel/UCA12_N7dGq648OwmCMCGMsg', 'FFFFFF'],
			['Spynt',				'discord',		'Gave a lot of helpfull advice',					'https://twitter.com/TheSpyFromTF', 'FF1C1C'],
			['Playtesters'],
			['Nate',				'discord',		'Alpha tester',										'https://www.google.com', '03FFDD'],
			[''],
			['Psych Engine Team'],

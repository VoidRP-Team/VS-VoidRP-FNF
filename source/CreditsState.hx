...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			['Special thanks'],
			['Spynt',				'discord',		'Gave permissions to use his character',					'https://twitter.com/TheSpyFromTF', 'FF1C1C'],
			['Twig_Kitten',				'discord',		'Gave permissions to use their character',					'https://google.com', 'FF1C1C'],
			['Lord_Oddiues',			'discord',		'Gave permissions to use his character',					'https://google.com', 'FFFFFF'],
			['Psych Engine Team'],
